...
#if CONFIG_FMN_BATTERY_TYPE_POWERED
#define BATTERY_TYPE 0
#elif CONFIG_FMN_BATTERY_TYPE_NON_RECHARGEABLE
#define BATTERY_TYPE 1
#elif CONFIG_FMN_BATTERY_TYPE_RECHARGEABLE
				 ...
				 void *buf, uint16_t len, uint16_t offset)
{
	...
	acc_category[0] = CONFIG_FMN_ACC_CATEGORY;
				     ...
				     void *buf, uint16_t len, uint16_t offset)
{
	...
	WRITE_BIT(acc_capabilities, BT_ACC_CAPABILITIES_PLAY_SOUND,
		  IS_ENABLED(CONFIG_FMN_ACC_CAPABILITY_PLAY_SOUND_ENABLED));
	WRITE_BIT(acc_capabilities, BT_ACC_CAPABILITIES_DETECT_MOTION,
		  IS_ENABLED(CONFIG_FMN_ACC_CAPABILITY_DETECT_MOTION_ENABLED));
	WRITE_BIT(acc_capabilities, BT_ACC_CAPABILITIES_NFC_SN_LOOKUP,
		  IS_ENABLED(CONFIG_FMN_ACC_CAPABILITY_NFC_SN_LOOKUP_ENABLED));
	WRITE_BIT(acc_capabilities, BT_ACC_CAPABILITIES_BLE_SN_LOOKUP,
		  IS_ENABLED(CONFIG_FMN_ACC_CAPABILITY_BLE_SN_LOOKUP_ENABLED));
	WRITE_BIT(acc_capabilities, BT_ACC_CAPABILITIES_FW_UPDATE_SVC,
		  IS_ENABLED(CONFIG_FMN_ACC_CAPABILITY_FW_UPDATE_SVC_ENABLED));
